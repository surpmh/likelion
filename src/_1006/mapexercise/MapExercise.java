...
public class MapExercise {
    public static void main(String[] args) {
        ...
        map.put("오세아", "https://github.com/su0545/like-lion-java.git");
        ...
        map.put("노석현", "https://github.com/su0545/like-lion-java.git");
        ...
        map.put("백다은", "https://github.com/su0545/like-lion-java.git");
        ...
        map.put("신여준", "https://github.com/su0545/like-lion-java.git");
        ...
        for (String k : map.keySet()) {
            System.out.println("git 주소: " + map.get(k));
        }
